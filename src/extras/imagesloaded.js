...
function defineImagesLoaded( EventEmitter, eventie ) {
  ...
  // XXX: SYSLAB MODIFICATION
  // If the cache is not cleared upon inject, then imagesLoaded wrongly tells
  // us that the images are alread loaded (by looking in the cache).
